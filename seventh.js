...
function Trusted_by_leading_brand () {
    return(
        <div class="mainContainer">
            <div class="textTdiv">
                <h1>Trusted by Leading Brands</h1>
                <p>Our methods for learning to code all are provided within a safe, moderated community that is built
...
export default Trusted_by_leading_brand